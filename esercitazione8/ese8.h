...
public:
    ...
    void add_edge(T a, T b){
        ...
        //aggiungo l'arco sia alla "lista" che parte fa from
        adiacenza[arco.from()].insert(arco.to());
        //che alla "lista" che parte da to
        adiacenza[arco.to()].insert(arco.from());
    }
